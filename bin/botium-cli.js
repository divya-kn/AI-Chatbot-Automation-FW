...
yargsCmd.usage('Botium CLI\n\nUsage: $0 [options]') // eslint-disable-line
  ...
  .command(wrapHandler(require('../botium-connector-alexa-avs')))
  .command(wrapHandler(require('../botium-connector-google-assistant')))
  .command(wrapHandler(require('../botium-connector-webdriverio')))
  ...
  .option('config', {
    ...
    nargs: 1,
    default: '../Config/botium-ACE.json'
  })
  .argv
